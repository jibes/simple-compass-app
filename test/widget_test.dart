...
import 'package:simple_compass_app/main.dart';

void main() {
  testWidgets('Compass app loads correctly', (WidgetTester tester) async {
    // Build our app and trigger a frame.
    await tester.pumpWidget(const CompassApp());

    // Verify that the app bar title is present
    expect(find.text('Simple Compass'), findsOneWidget);
  });
}
